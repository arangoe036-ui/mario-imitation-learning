> ## ⚠ SUPERSEDED — archived 2026-08-04
>
> This document is kept for provenance and is **not the current result.** It predates blocks
> 53–66. Its headline (+23.8 pp at pipe 3) has been replaced by the Koopas result, which is
> the one positive that survives ten paired seeds and multiplicity correction.
>
> **Read [`../README.md`](../README.md) for what currently stands**, and
> [`RESEARCH_LOG.md`](RESEARCH_LOG.md) for how each claim was reached, revised, or withdrawn.
